...
namespace Common.Commons
{
    public class RuntimeClassBuilder
    {
        ...
        public Type CreateType(List<string> PropertyNames, List<Type> Types)
        {
            if (PropertyNames.Count != Types.Count)
            {
        ...
        {
            TypeBuilder typeBuilder = Constants.MODULE_BUILDER.DefineType(this.asemblyName.FullName
